...
function HpBar({ label, hp, faction, hit }: { label: string; hp: number; faction: Faction; hit?: boolean }) {
  ...
  return (
    <div className="min-w-[120px] flex-1">
      <div className="flex items-center justify-between font-sans text-xs uppercase tracking-[0.24em] text-zinc-300">
        <span>{label}</span>
    ...
    <div className="deep-panel flex flex-wrap items-center justify-between gap-3 rounded-lg border border-border bg-card/70 px-4 py-3 backdrop-blur">
      <div className="flex items-center gap-4">
        <div className="text-center">
          <div className="font-sans text-[10px] uppercase tracking-[0.24em] text-zinc-400">Round</div>
          <div className="font-display text-2xl leading-none text-gold">{round}/12</div>
        </div>
        <div className="text-center">
          <div className="font-sans text-[10px] uppercase tracking-[0.24em] text-zinc-400">Faction</div>
          <div
        ...
        <div className="text-center">
          <div className="font-sans text-[10px] uppercase tracking-[0.24em] text-zinc-400">Score</div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="text-center">
          <div className="font-sans text-[10px] uppercase tracking-[0.24em] text-zinc-400">Timer</div>
          <div
        ...
        {drillProgress > 0 && (
          <div className="text-center" aria-label={`Drill depth ${drillProgress} of 5`}>
            <div className="font-sans text-[10px] uppercase tracking-[0.24em] text-zinc-400">Drill</div>
